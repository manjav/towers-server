...
public class RankingUtils
{
    ...
    public void fillActives()
    {
        ...
        try {
            ...
            ext.trace("filled in-memory tops in " + (System.currentTimeMillis() - (long)ext.getParentZone().getProperty("startTime")) + " milliseconds.", NUM_USERS);
        } catch (SQLException e) { e.printStackTrace(); }
