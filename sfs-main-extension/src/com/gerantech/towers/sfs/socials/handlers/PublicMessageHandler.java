    ...
    public void handleClientRequest(User sender, ISFSObject params)
    {
        ...
        if( params.getShort("m") == MessageTypes.M30_FRIENDLY_BATTLE )
        {
            ...
            if (friendlyBattleId == -1)
            {
                ...
                getParentExtension().getParentRoom().setProperty(room.getName(), true);
            ...
            else if (friendlyBattleId > -1)
            {
                ...
                if ( params.getShort("st") < 2 )
                    BattleAutoJoinHandler.join(getApi(), sender, room, params.containsKey("sp") ? params.getText("s") : "");
                else
