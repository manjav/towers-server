...
public class InfractionsGetHandler extends BaseClientRequestHandler
{
	public void handleClientRequest(User sender, ISFSObject params)
    {
		...
		String query = "SELECT players.name, infractions.reporter, infractions.offender, infractions.content, infractions.lobby, infractions.offend_at FROM players INNER JOIN infractions ON players.id = infractions.offender";
